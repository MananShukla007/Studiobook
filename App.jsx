...
// Floating Particles Background - Memoized
...
// Animated Gradient Orbs - Memoized
...
// Static Counter (doesn't re-animate on every render)
...
export default function StudioBookApp() {
  ...
  const getAvailableSlots = (roomId) => {
    return timeSlots.filter(slot => !isSlotBooked(roomId, selectedDate, slot.time) && !isSlotBlocked(roomId, selectedDate, slot.time)).length;
  };
              ...
              <div className="space-y-6">
                <GlassCard className="p-6">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all outline-none"
                  />
                </GlassCard>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/40 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all outline-none"
                      />
                    </div>
